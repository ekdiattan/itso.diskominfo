...
@section('container')
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            <a href="pdf_cuti" target="_blank" class="btn btn-success"><i class="fa fa-file-excel-o"></i>Export PDF</a>
            <a href="store-cuti" class="btn btn-primary"></i> Update Data</a>
        </div> 
        <br>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <select class="form-control input-sm select2 select2-hidden-accessible" id="status" name="status"
                        ...
                        <option value="1" selected href="/cuti">Semua Data</option>
                        <option value="2" href="/sedang-cuti">Sedang Cuti</option>
                    </select>
                    <script>
            ...
            <div class="table-responsive">
                <div class="form-inline dt-bootstrap no-footer">
                    <div class="table-responsive table-min-height">
                        <div id="dataTable_wrapper" class="box-body">
                            <table id="dataTable" class="table table-bordered table-contextual">
