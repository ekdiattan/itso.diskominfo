                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <select class="form-control input-sm select2" id="status" name="status" onChange="location = this.value">
                                            <option value="/rekap/terlambat-masuk">Rekapitulasi Terlambat Masuk PNS</option>
                                            <option selected value="/rekap/terlambat-masuk-unit">Rekapitulasi Terlambat Masuk Unit</option>
