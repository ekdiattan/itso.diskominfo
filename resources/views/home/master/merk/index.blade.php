              ...
              <div class="preview-list">
                <div id="dataTable_wrapper" class="table-responsive">
                    <table id="dataTable" class="table table-hover table-bordered table-striped">
                      ...
                      <tbody>
                      @foreach ($merks as $key => $post ) 
                        <tr>
                          <td>{{ $merks->firstItem() + $key }}</td>
                          <td>{{ $post->merk }}</td>
                          <td>
                            <a href="/merk/{{ $post->id }}" class="badge bg-warning"><span
                                class="menu-icon"><i class="far fa-edit"></i></span></a>
                            <form action="/merk/delete/{{ $post->id }}" method="get" class="d-inline">
                            @method('delete')
                            @csrf
